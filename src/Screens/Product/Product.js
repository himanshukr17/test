...
const Product = ({ navigation }) => {
    ...
    const fetchProducts = async () => {
        ...
        try {
            const res = await axios.get("http://172.16.16.215:5000/RWA/Product/all");
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.header}>
                        <View style={styles.topRow}>
                            ...
                            <Text style={styles.titled}>Product</Text>
                ...
                {product.length == 0 ? (
                    <Text style={styles.noData}>Sorry No Product Available</Text>
                ) : (
                    <>
                                        ...
                                        <View>
                                            <View style={{ alignItems: 'flex-start' }}>
                                                ...
                                                <View style={{ backgroundColor: '#d0d0d0ff', paddingVertical: 2, paddingHorizontal: 8, borderRadius: 4 }}>
                                                    <Text style={{ color: '#2b2a2aff', fontWeight: 'bold', fontSize: 10 }}>₹ {product.PRICE}</Text>
                                                </View>
