...
const CDirectory = ({ navigation }) => {
    ...
    const fetchUsers = async () => {
        try {
            const res = await axios.get("http://172.16.16.215:5000/RWA/User/committee");
            if (res.data.success) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.topRow}>
                    ...
                    <Text style={styles.titled}>Commiittee Members Directory</Text>
                </View>
            </View>
            </LinearGradient>
